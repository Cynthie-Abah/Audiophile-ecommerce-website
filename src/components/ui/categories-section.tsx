...
const CategoriesSection = () => {
  return (
      <div className="lg:max-w-[1110px] mx-auto md:pt-32 md:py-36 px-8 md:px-0 categories flex flex-col sm:flex-row gap-4 md:gap-7 justify-center md:justify-between">
