...
export const CatBox = ({ link, imageSrc, catName }: CatBoxProps) => {
    return (
        <div className="cat-box relative bg-gray-light w-full my-14 sm:w-[33%] md:w-[30%] md:min-w-[223px] h-[207px] rounded-md flex items-center justify-center">
            ...
            <div className="flex flex-col items-center gap-2 mt-auto mb-7">
                <h3 className="text-black uppercase tracking-widest text-lg font-semibold">{catName}</h3>
